// @liveleague/core — shared pure-TS logic used by both the web app and the
...
// e.g. `import { winProb } from "@liveleague/core/win-prob"`.
//
...
//   import type { Match } from "@liveleague/core/types";       // soccer domain
//   import type { ApiMatch } from "@liveleague/core/api-shape"; // API DTOs
